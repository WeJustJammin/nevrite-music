...
- `.agents/skills/prd-templates/references/ideation-index-template.md` (super-index)
- `.agents/skills/prd-templates/references/ideation-crosscut-template.md` (global CX)
- `.agents/skills/prd-templates/references/fractal-node-index-template.md` (node index)
- `.agents/skills/prd-templates/references/fractal-cx-template.md` (node CX)
- `.agents/skills/prd-templates/references/fractal-feature-template.md` (feature file)
