...
2. **Classification Gate**: Apply Node Classification Gate from `.agents/skills/idea-extraction/SKILL.md` — leaf feature or sub-domain folder.
3. **Write**: Use `.agents/skills/prd-templates/references/fractal-feature-template.md`. Include:
