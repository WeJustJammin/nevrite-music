...
1. `.codex/instructions/tech-stack.md` must exist and be populated
...
1. Open `.codex/instructions/tech-stack.md`
...
**Check**: Does `.codex/skills/{skill-name}/SKILL.md` exist?
...
**Check**: Does any skill in `.codex/skills/` partially match the name?
...
1. `.codex/skill-library/` — Check if skill template exists in library
...
- **Option 3**: Generate stub skill at `.codex/skills/{skill}/SKILL.md`, load it
...
```json
{
  "resolved": [
    ...
    ".codex/skills/surrealdb/SKILL.md"
  ],
  "missing": ["pglite"],
  "warnings": [
...
- `.codex/instructions/tech-stack.md` — Surface Stack Map source
- `.codex/skills/setup/setup-provision-skills.md` — Skill installation
- `.codex/skills/setup/setup-cfsa.md` — Initial setup workflow
