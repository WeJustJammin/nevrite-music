...
- `.codex/instructions/tech-stack.md` — Technology decisions
- `.codex/instructions/patterns.md` — Code conventions
- `.codex/instructions/structure.md` — Directory layout
- `.codex/instructions/commands.md` — Dev, test, lint, build
