...
2. **Classification Gate**: Apply Node Classification Gate from `.codex/skills/idea-extraction/SKILL.md` — leaf feature or sub-domain folder.
3. **Write**: Use `.codex/skills/prd-templates/references/fractal-feature-template.md`. Include:
