/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareEnv` (hash: a5eaf8e27e6d1ad05da28b6923b136a4)
// Runtime types generated with workerd@1.20260828.1 2026-08-26 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	PLATFORM_API: Fetcher /* wejammin-api-staging */ | Fetcher /* wejammin-api */;
}
declare namespace Cloudflare {
	interface StagingEnv {
		ASSETS: Fetcher;
		PLATFORM_API: Fetcher /* wejammin-api-staging */;
	}
