...
Pipeline workflow skills now live directly under `.claude/skills/<workflow-name>/SKILL.md`. Parent workflows and shard workflows both use the same top-level directory pattern so Claude can resolve them as proper skills.

Examples:
- `.claude/skills/ideate/SKILL.md`
- `.claude/skills/create-prd/SKILL.md`
- `.claude/skills/write-fe-spec/SKILL.md`
- `.claude/skills/plan-phase/SKILL.md`
