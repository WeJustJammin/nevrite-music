...
|---------|-----------|---------------|---------------|-----------|------|------------|-----------|------------|-----------|----------|----------------|----------|-----------|---------|-------------|
| web | typescript-advanced-patterns | hono | astro-framework, react-best-practices | — | supabase-data-access | — | supabase-data-access | vitest | playwright | pnpm test | pnpm validate | pnpm lint | pnpm build | pnpm dev | pnpm |
...
| Stack Summary | TypeScript; Astro hybrid web with React islands; Hono on Cloudflare Workers; Supabase Free PostgreSQL/Auth/Storage/Realtime; Zod 4 REST/OpenAPI contracts; pnpm, Vitest, Playwright; GitHub Actions; structured logs. |
...
- typescript-advanced-patterns — Strict TypeScript contracts, discriminated UI state unions, branded identifiers, and exhaustive type-safe rendering (surface: web, column: Languages).
