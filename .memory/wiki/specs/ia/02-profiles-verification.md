...
| PRF-08 | Contest ownership | Notify both sides, preserve current operation, collect comparable proof for 14 days, and block transfer. | Strong uncontested challenger evidence may win reversibly; credible conflict freezes control and routes a `CaseKind = ownership` case to Shard 06 (TSE-01 intake, TSE-13 resolution). |
