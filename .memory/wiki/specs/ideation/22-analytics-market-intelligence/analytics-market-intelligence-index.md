...
| Q-02 | **Is a label A&R a distinct persona, or a Producer in an org context?** D-04 assumes the latter. Directly parallels personas.md Q-01 (dealer persona for 13/14/15). If "distinct persona", 22.07's Role Matrix is wrong. | User | `/ideate-validate` |
| Q-03 | **Does 22.08 belong in domain 22 or domain 02 (Credits & Attribution)?** It is the credit graph's payoff. For 22: it needs the whole ingestion/matching machine. For 02: the credit graph is the subject and 22 is merely a data source. Genuinely unresolved. | User | `/ideate-validate` |
| Q-04 | **Adopt D-07 as a platform principle?** Three independent features concluded "don't monetise the recommendation surface". The owner should see the pattern whole rather than as three footnotes — and decide before revenue depends on the answer. | User | `/ideate-validate` |
