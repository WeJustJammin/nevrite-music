...
| R-02 | 04.06 Band & Member Wanted | 04.07 Open Calls | Considered merging as "the two non-standard types". Rejected — non-standard in opposite directions. Member-wanted is one-to-one, **duration-bounded**, unpaid, mutual, often confidential; an open call is many-to-few, deadline-bound, curated, public. **Reconciled 2026-07-30** — this row read "open-ended" until the owner ratified member-wanted's decide-by as **publication + 90 days** (`04.01.01` D-16 as amended; 04.06 Q-05 → 04.06 D-05). The rejection survives the correction and is sharpened by it: both types are now bounded, but by opposite instruments — a duration the platform derives at publish, against a date the Operator states and every applicant works towards. Sharing "doesn't fit the spine" is still not a relationship. |
