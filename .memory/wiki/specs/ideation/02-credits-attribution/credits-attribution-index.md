...
| D-13 | **An objection to an evidence-based embargo lift is a stated-ground challenge that pauses at the status quo and resolves on the dispute engine — never a Producer veto** | Owner ratification of DQ-03 axes A2–A5. Closed ground list restricted to `02.01.05` D-03's own predicate; platform re-verification is the free first rung; a resolution SLA is mandatory; re-submission is unbounded. Keeps `02.01.05` D-11's Producer-off-the-critical-path rationale intact and preserves Q-04's forgery compensating control. Two costs recorded: contested lifts inherit `02.05` ladder latency, and per-objection adjudication load lands on domain 24 unbudgeted. The publicly-reachable-but-unauthorised recording (leak/bootleg) is a **known open gap** (`02.01.05` Q-07). | `02.01.05` D-19–D-22; `02.05` D-07 |
...
| Q-14 | **The publicly-reachable-but-unauthorised recording** (`02.01.05` Q-07). A leak or bootleg is "demonstrably public" under `02.01.05` D-03 and no closed objection ground covers it, because no source defines an authorised-vs-unauthorised predicate and creating one would make domain 12 the authority for "authorised release". Recorded as an accepted gap, not an oversight. | User | `/create-prd` |
