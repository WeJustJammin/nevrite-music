...
> **BE Source**: [06a-case-intake-evidence.md](../be/06a-case-intake-evidence.md), [06b-policy-enforcement-appeals.md](../be/06b-policy-enforcement-appeals.md), [06c-disputes-dmca-legal-risk.md](../be/06c-disputes-dmca-legal-risk.md)
> **IA Source**: [06-trust-safety.md](../ia/06-trust-safety.md)
> **Surface**: Responsive Astro hybrid web/PWA with bounded React islands
> **Status**: Complete

## Referenced Material Inventory

- **Primary IA**: [06-trust-safety.md](../ia/06-trust-safety.md) in full.
- **BE sources**: [06a-case-intake-evidence.md](../be/06a-case-intake-evidence.md), [06b-policy-enforcement-appeals.md](../be/06b-policy-enforcement-appeals.md), [06c-disputes-dmca-legal-risk.md](../be/06c-disputes-dmca-legal-risk.md).
...
|---|---|---|
| Classification and scope | `06-trust-safety.md`; BE index | Shard boundary and completed BE split group |
...
### `TrustSafetyRoute` (Astro server route)

```ts
interface TrustSafetyRouteProps {
  children?: never;
...
### `CaseIntakeEvidenceWorkbench` (bounded React island)

**BE owner**: `06a-case-intake-evidence.md`

```ts
interface CaseIntakeEvidenceWorkbenchProps {
  contractFields: CaseIntakeEvidenceWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly CaseIntakeEvidenceRecord[]>;
  actorId: string;
...
interface CaseIntakeEvidenceRecord {
  id: string;
  version: string;
  state: string;
...
### `PolicyEnforcementAppealsWorkbench` (bounded React island)

**BE owner**: `06b-policy-enforcement-appeals.md`

```ts
interface PolicyEnforcementAppealsWorkbenchProps {
  contractFields: PolicyEnforcementAppealsWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly PolicyEnforcementAppealsRecord[]>;
  actorId: string;
  actingPartyId: string;
  access: AccessVariant;
  query: Readonly<Record<string, string>>;
...
interface PolicyEnforcementAppealsRecord {
  id: string;
  version: string;
  state: string;
  provenance: ReadonlyArray<{ source: string; evidence: string; at: string; visibility: string }>;
...
### `DisputesDmcaLegalRiskWorkbench` (bounded React island)

**BE owner**: `06c-disputes-dmca-legal-risk.md`

```ts
interface DisputesDmcaLegalRiskWorkbenchProps {
  contractFields: DisputesDmcaLegalRiskWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly DisputesDmcaLegalRiskRecord[]>;
  actorId: string;
  actingPartyId: string;
  access: AccessVariant;
  query: Readonly<Record<string, string>>;
...
interface DisputesDmcaLegalRiskRecord {
  id: string;
  version: string;
  state: string;
  provenance: ReadonlyArray<{ source: string; evidence: string; at: string; visibility: string }>;
...
|---|---|---|---|
| `/app/trust-safety` | Astro SSR or cache-safe prerender by route registry | Public exposes public projection; protected verifies session/acting context; admin requires explicit capability and named step-up | Query, cursor, selected record, tab are URL state; invalid values normalize with `replaceState`; Back restores selection/scroll |
| `/app/trust-safety/:recordId` | Server-first detail with bounded islands | Concealed returns disclosure-safe 404; visible forbidden uses `<CapabilityGate>`; expired session preserves safe return target | Bookmark resolves current canonical version; stale/deleted target shows exact state and safe parent |
...
|---|---|---|---|---|---|
| `TSE-01` Submit safety report | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-02` Submit legal/DMCA notice | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-03` Route and claim case | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-04` Review case | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-05` Apply sanction/takedown | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-06` Concur or reaffirm | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-07` Appeal decision | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-08` Restrict another user | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-09` Evaluate advisory signal | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-10` Open transaction dispute | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-11` Mediate or adjudicate | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-12` Process DMCA counter-notice | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-13` Resolve identity/ownership case | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-14` Handle safety/crisis intake | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-15` Receive legal process | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-16` Capture evidence | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-17` Place/release legal hold | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-18` Assess domain-launch risk | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-19` Submit trusted-flagger notice | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-20` Evaluate message-safety signal | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-21` Defend card testing and triangulation | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-22` Adjudicate review integrity | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-23` Review authenticity or counterfeit claim | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-24` Respond to pre-release leak | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-25` Attach meetup safety layer | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `TSE-26` Apply TVEC removal | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
...
|---|---|---|---|---|
| Route shell/navigation | 1.3.1, 2.4.1–2.4.3, 2.4.7/2.4.11 | Skip link; logical DOM; route focuses `h1` | Named landmarks, one main, `aria-current=page`, unique title | `06-trust-safety.md` Accessibility/User Flows |
| Workbench selection | 1.3.1, 2.1.1, 2.4.3, 4.1.2 | Native controls; Enter opens; Escape closes bounded inspector; focus returns | Named list/detail; selected state; state/provenance text | `06-trust-safety.md` Interactions/Access Control |
| Forms/validation | 1.3.1, 3.3.1–3.3.4, 4.1.3 | Persistent labels; linked summary focuses first invalid field; no trap | `aria-invalid`, `aria-describedby`, error links, polite status | `06-trust-safety.md` Acceptance Criteria/Edge Cases |
| Async/refetch/conflict | 2.2.1, 2.4.3, 4.1.3 | Refresh never steals focus; Retry native; conflict begins at heading | Polite atomic update; stale/pending/failed text; request ID | `06-trust-safety.md` Interactions/BE failures |
| Tables/filters | 1.3.1, 1.4.10, 2.1.1, 2.5.8 | Header buttons; Apply/Reset; 24 CSS px minimum, 44 preferred | Caption, headers, sort, count, active-filter summary | `06-trust-safety.md` User Flows/responsive |
| High-risk confirmation | 2.1.2, 2.4.3, 3.3.4, 4.1.2 | Inline first; dialog heading focus, Tab containment, Escape before commit, return focus | Consequence, scope, version, context, step-up, irreversible effect | `06-trust-safety.md` Access Control/Edge Cases |
| Motion/media | 1.2.x where applicable, 2.2.2, 2.3.3 | Media keyboard controls; pause/stop; no essential timed gesture | Captions/transcript/metadata; reduced motion; waveform never sole content | `06-trust-safety.md` Accessibility |
...
|---|---|---|---|---|
| `TrustSafetyRoute` | `TrustSafetyRouteProps` | `never` | `publicPage`, `appPage`, `adminPage`, `authPage`, `degradedPage` | `06-trust-safety.md` user flows/accessibility; design-system page archetypes |
| `CaseIntakeEvidenceWorkbench` | `CaseIntakeEvidenceWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `06a-case-intake-evidence.md` request/response fields; `06-trust-safety.md` interactions/access rules |
| `PolicyEnforcementAppealsWorkbench` | `PolicyEnforcementAppealsWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `06b-policy-enforcement-appeals.md` request/response fields; `06-trust-safety.md` interactions/access rules |
| `DisputesDmcaLegalRiskWorkbench` | `DisputesDmcaLegalRiskWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `06c-disputes-dmca-legal-risk.md` request/response fields; `06-trust-safety.md` interactions/access rules |
...
|---|---|---|---|
| `TSE-01` Submit safety report | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-01` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-02` Submit legal/DMCA notice | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-02` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-03` Route and claim case | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-03` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-04` Review case | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-04` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-05` Apply sanction/takedown | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-05` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-06` Concur or reaffirm | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-06` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-07` Appeal decision | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-07` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-08` Restrict another user | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-08` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-09` Evaluate advisory signal | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-09` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-10` Open transaction dispute | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-10` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-11` Mediate or adjudicate | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-11` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-12` Process DMCA counter-notice | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-12` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-13` Resolve identity/ownership case | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-13` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-14` Handle safety/crisis intake | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-14` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-15` Receive legal process | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-15` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-16` Capture evidence | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-16` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-17` Place/release legal hold | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-17` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-18` Assess domain-launch risk | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-18` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-19` Submit trusted-flagger notice | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-19` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-20` Evaluate message-safety signal | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-20` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-21` Defend card testing and triangulation | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-21` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-22` Adjudicate review integrity | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-22` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-23` Review authenticity or counterfeit claim | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-23` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-24` Respond to pre-release leak | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-24` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-25` Attach meetup safety layer | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-25` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `TSE-26` Apply TVEC removal | `TrustSafetyRoute` orchestrates; `CaseIntakeEvidenceWorkbench`, `PolicyEnforcementAppealsWorkbench`, `DisputesDmcaLegalRiskWorkbench` renders the relevant BE response and command state | `06-trust-safety.md` Interactions row `TSE-26` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
...
|---|---|---|---|---|
| `/app/trust-safety` | Server validates Supabase token, expiry, acting context, and route capability. Missing/expired token redirects 303 to `/auth/sign-in?returnTo=%2Fapp%2Ftrust-safety` after allowlist normalization. Valid but concealed target returns 404; visible forbidden target renders `CapabilityGate`. | `TrustSafetyRoute` variant `appPage` | `Trust, safety, disputes and evidence | WeJammin` | `Work with trust, safety, disputes and evidence using current authority, record state, and provenance.` |
| `/app/trust-safety/:recordId` | Same token/expiry/context check; malformed ID returns 400, concealed/unreadable returns 404, expired session uses the same safe sign-in redirect. | `TrustSafetyRoute` with the matching workbench detail variant | `Record | Trust, safety, disputes and evidence | WeJammin` | `Review the current record, provenance, history, and permitted actions.` |
| Public projection when a BE route declares one | No session accepted as authority; public projection only. Unsafe or non-public record returns disclosure-safe 404, never app-shell redirect. | `TrustSafetyRoute` variant `publicPage` | `Trust, safety, disputes and evidence | WeJammin` | `View the public, provenance-labelled record.` |
| System/degraded boundary | Preserves verified shell only; Retry stays on canonical URL; unsafe cached data is removed. | `TrustSafetyRoute` variant `degradedPage` | `Service status | WeJammin` | `Review affected scope, last verified time, request ID, and recovery action.` |

### Per-component responsive contract

| Component | Mobile ≤768 px | Tablet 769–1024 px | Desktop ≥1025 px |
|---|---|---|---|
| `TrustSafetyRoute` | Four-column shell, 16 px gutter/margins, compact tabs, stack navigation, Back before detail, no horizontal page scroll at 320 CSS px | Eight-column shell, 20 px gutter, 24 px margins, collapsible sidebar, list/inspector when container permits | Twelve-column shell, 24 px gutter, max 1440 px, persistent sidebar/top bar, stable route heading/action region |
| `CaseIntakeEvidenceWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
| `PolicyEnforcementAppealsWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
| `DisputesDmcaLegalRiskWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
...
|---|---|---|---|---|
| `06a-case-intake-evidence.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
| `06b-policy-enforcement-appeals.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
| `06c-disputes-dmca-legal-risk.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
...
|---|---|---|---|---|
| `06a-case-intake-evidence.md` | `06A-CASE-INTAKE-EVIDENCE-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `CaseIntakeEvidenceWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |
| `06b-policy-enforcement-appeals.md` | `06B-POLICY-ENFORCEMENT-APPEALS-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `PolicyEnforcementAppealsWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |
| `06c-disputes-dmca-legal-risk.md` | `06C-DISPUTES-DMCA-LEGAL-RISK-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `DisputesDmcaLegalRiskWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |

### Response field ownership

| BE source | Contract schemas | Parsed field set | UI ownership |
|---|---|---|---|
| `06a-case-intake-evidence.md` | Named source schemas | All named response fields | `CaseIntakeEvidenceWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
| `06b-policy-enforcement-appeals.md` | Named source schemas | All named response fields | `PolicyEnforcementAppealsWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
| `06c-disputes-dmca-legal-risk.md` | Named source schemas | All named response fields | `DisputesDmcaLegalRiskWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
...
```ts
type CaseIntakeEvidenceContractField =
  never;
interface CaseIntakeEvidenceWorkbenchContractFields {
  source: '06a-case-intake-evidence.md';
  fields: Readonly<Record<CaseIntakeEvidenceContractField, unknown>>;
}
```

```ts
type PolicyEnforcementAppealsContractField =
  never;
interface PolicyEnforcementAppealsWorkbenchContractFields {
  source: '06b-policy-enforcement-appeals.md';
  fields: Readonly<Record<PolicyEnforcementAppealsContractField, unknown>>;
}
```

```ts
type DisputesDmcaLegalRiskContractField =
  never;
interface DisputesDmcaLegalRiskWorkbenchContractFields {
  source: '06c-disputes-dmca-legal-risk.md';
  fields: Readonly<Record<DisputesDmcaLegalRiskContractField, unknown>>;
}
```

| BE source | Owning component/prop | Every discovered application error code | UI state owner |
|---|---|---|---|
| `06a-case-intake-evidence.md` | `CaseIntakeEvidenceWorkbenchContractFields.fields` and `CaseIntakeEvidenceWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `CAPTURE_FAILED`, `CASE_NOT_FOUND`, `FORBIDDEN`, `HOLD_NOT_FOUND`, `IDEMPOTENCY_MISMATCH`, `INVALID_REQUEST`, `NOT_FOUND`, `POLICY_VERSION_INVALID`, `PROVIDER_UNAVAILABLE`, `RATE_LIMITED`, `STEP_UP_REQUIRED`, `SUBJECT_NOT_FOUND`, `TARGET_NOT_FOUND`, `UNAUTHENTICATED`, `UPSTREAM_TIMEOUT`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
| `06b-policy-enforcement-appeals.md` | `PolicyEnforcementAppealsWorkbenchContractFields.fields` and `PolicyEnforcementAppealsWorkbenchProps.contractFields` | `CASE_NOT_FOUND`, `CONTROL_REQUIRED`, `DECISION_NOT_FOUND`, `FORBIDDEN`, `IDEMPOTENCY_MISMATCH`, `INVALID_REQUEST`, `NOT_FOUND`, `OBJECT_NOT_FOUND`, `POLICY_VERSION_INVALID`, `PROVIDER_UNAVAILABLE`, `REVIEW_NOT_FOUND`, `RISK_INVALID`, `STEP_UP_REQUIRED`, `THREAD_NOT_FOUND`, `TRANSACTION_NOT_FOUND`, `UNAUTHENTICATED`, `UPSTREAM_TIMEOUT`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
| `06c-disputes-dmca-legal-risk.md` | `DisputesDmcaLegalRiskWorkbenchContractFields.fields` and `DisputesDmcaLegalRiskWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `ARRANGEMENT_NOT_FOUND`, `ASSET_NOT_FOUND`, `CASE_NOT_FOUND`, `DELIVERY_FAILED`, `DISCLOSURE_ACK_REQUIRED`, `DOMAIN_NOT_FOUND`, `EVIDENCE_RULE_INVALID`, `FORBIDDEN`, `GRANT_NOT_FOUND`, `IDEMPOTENCY_MISMATCH`, `INVALID_REQUEST`, `ITEM_KEY_REQUIRED`, `LISTING_NOT_FOUND`, `MANDATE_REQUIRED`, `NOTICE_NOT_FOUND`, `OWNERSHIP_MUTATION_FORBIDDEN`, `POLICY_VERSION_INVALID`, `PROVIDER_UNAVAILABLE`, `REQUEST_NOT_FOUND`, `SIGNATURE_REQUIRED`, `STEP_UP_REQUIRED`, `TRANSACTION_NOT_FOUND`, `UNAUTHENTICATED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
