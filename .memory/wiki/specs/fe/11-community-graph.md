...
> **BE Source**: [11a-follows-connections-endorsements.md](../be/11a-follows-connections-endorsements.md), [11b-activity-feed-native-posts.md](../be/11b-activity-feed-native-posts.md), [11c-collaborator-discovery-calls.md](../be/11c-collaborator-discovery-calls.md), [11d-collaboration-paths-warm-intros.md](../be/11d-collaboration-paths-warm-intros.md), [11e-private-rolodex-crm.md](../be/11e-private-rolodex-crm.md)
> **IA Source**: [11-community-graph.md](../ia/11-community-graph.md)
> **Surface**: Responsive Astro hybrid web/PWA with bounded React islands
> **Status**: Complete

## Referenced Material Inventory

- **Primary IA**: [11-community-graph.md](../ia/11-community-graph.md) in full.
- **BE sources**: [11a-follows-connections-endorsements.md](../be/11a-follows-connections-endorsements.md), [11b-activity-feed-native-posts.md](../be/11b-activity-feed-native-posts.md), [11c-collaborator-discovery-calls.md](../be/11c-collaborator-discovery-calls.md), [11d-collaboration-paths-warm-intros.md](../be/11d-collaboration-paths-warm-intros.md), [11e-private-rolodex-crm.md](../be/11e-private-rolodex-crm.md).
...
|---|---|---|
| Classification and scope | `11-community-graph.md`; BE index | Shard boundary and completed BE split group |
...
### `CommunityGraphRoute` (Astro server route)

```ts
interface CommunityGraphRouteProps {
  children?: never;
...
### `FollowsConnectionsEndorsementsWorkbench` (bounded React island)

**BE owner**: `11a-follows-connections-endorsements.md`

```ts
interface FollowsConnectionsEndorsementsWorkbenchProps {
  contractFields: FollowsConnectionsEndorsementsWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly FollowsConnectionsEndorsementsRecord[]>;
  actorId: string;
...
interface FollowsConnectionsEndorsementsRecord {
  id: string;
  version: string;
  state: string;
...
### `ActivityFeedNativePostsWorkbench` (bounded React island)

**BE owner**: `11b-activity-feed-native-posts.md`

```ts
interface ActivityFeedNativePostsWorkbenchProps {
  contractFields: ActivityFeedNativePostsWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly ActivityFeedNativePostsRecord[]>;
  actorId: string;
  actingPartyId: string;
  access: AccessVariant;
  query: Readonly<Record<string, string>>;
...
interface ActivityFeedNativePostsRecord {
  id: string;
  version: string;
  state: string;
  provenance: ReadonlyArray<{ source: string; evidence: string; at: string; visibility: string }>;
...
### `CollaboratorDiscoveryCallsWorkbench` (bounded React island)

**BE owner**: `11c-collaborator-discovery-calls.md`

```ts
interface CollaboratorDiscoveryCallsWorkbenchProps {
  contractFields: CollaboratorDiscoveryCallsWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly CollaboratorDiscoveryCallsRecord[]>;
  actorId: string;
  actingPartyId: string;
  access: AccessVariant;
  query: Readonly<Record<string, string>>;
...
interface CollaboratorDiscoveryCallsRecord {
  id: string;
  version: string;
  state: string;
  provenance: ReadonlyArray<{ source: string; evidence: string; at: string; visibility: string }>;
...
### `CollaborationPathsWarmIntrosWorkbench` (bounded React island)

**BE owner**: `11d-collaboration-paths-warm-intros.md`

```ts
interface CollaborationPathsWarmIntrosWorkbenchProps {
  contractFields: CollaborationPathsWarmIntrosWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly CollaborationPathsWarmIntrosRecord[]>;
  actorId: string;
  actingPartyId: string;
  access: AccessVariant;
  query: Readonly<Record<string, string>>;
...
interface CollaborationPathsWarmIntrosRecord {
  id: string;
  version: string;
  state: string;
  provenance: ReadonlyArray<{ source: string; evidence: string; at: string; visibility: string }>;
...
### `PrivateRolodexCrmWorkbench` (bounded React island)

**BE owner**: `11e-private-rolodex-crm.md`

```ts
interface PrivateRolodexCrmWorkbenchProps {
  contractFields: PrivateRolodexCrmWorkbenchContractFields;
  children?: never;
  variant: DomainVariant;
  initial: AsyncState<readonly PrivateRolodexCrmRecord[]>;
  actorId: string;
  actingPartyId: string;
  access: AccessVariant;
  query: Readonly<Record<string, string>>;
...
interface PrivateRolodexCrmRecord {
  id: string;
  version: string;
  state: string;
  provenance: ReadonlyArray<{ source: string; evidence: string; at: string; visibility: string }>;
...
|---|---|---|---|
| `/app/community-graph` | Astro SSR or cache-safe prerender by route registry | Public exposes public projection; protected verifies session/acting context; admin requires explicit capability and named step-up | Query, cursor, selected record, tab are URL state; invalid values normalize with `replaceState`; Back restores selection/scroll |
| `/app/community-graph/:recordId` | Server-first detail with bounded islands | Concealed returns disclosure-safe 404; visible forbidden uses `<CapabilityGate>`; expired session preserves safe return target | Bookmark resolves current canonical version; stale/deleted target shows exact state and safe parent |
...
|---|---|---|---|---|---|
| `COM-01` Follow/unfollow entity | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-02` Request professional connection | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-03` Endorse collaborator | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-04` Read activity feed | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-05` Mute/reduce feed source | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-06` Publish/react to native post | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-07` Search collaborators | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-08` Set open-to status | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-09` Publish collaboration call | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-10` Accept call responder | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-11` Find intro path | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-12` Suppress graph edge | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-13` Request warm intro | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-14` Broker introduction | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-15` Evaluate reachability | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-16` Create/reconcile shadow contact | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-17` Add private note/tag/list | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
| `COM-18` Schedule follow-up | Native link/button/form; focus stays until navigation or named result heading | Server-derived actor/context/capability, valid Zod input, required ETag/idempotency | Render authoritative response/version/provenance/next action; announce status | Map exact `ApiError`; retain input; focus summary/field; reconcile unknown mutation before retry | URL for navigation/filter; scoped draft before commit; server after success |
...
|---|---|---|---|---|
| Route shell/navigation | 1.3.1, 2.4.1–2.4.3, 2.4.7/2.4.11 | Skip link; logical DOM; route focuses `h1` | Named landmarks, one main, `aria-current=page`, unique title | `11-community-graph.md` Accessibility/User Flows |
| Workbench selection | 1.3.1, 2.1.1, 2.4.3, 4.1.2 | Native controls; Enter opens; Escape closes bounded inspector; focus returns | Named list/detail; selected state; state/provenance text | `11-community-graph.md` Interactions/Access Control |
| Forms/validation | 1.3.1, 3.3.1–3.3.4, 4.1.3 | Persistent labels; linked summary focuses first invalid field; no trap | `aria-invalid`, `aria-describedby`, error links, polite status | `11-community-graph.md` Acceptance Criteria/Edge Cases |
| Async/refetch/conflict | 2.2.1, 2.4.3, 4.1.3 | Refresh never steals focus; Retry native; conflict begins at heading | Polite atomic update; stale/pending/failed text; request ID | `11-community-graph.md` Interactions/BE failures |
| Tables/filters | 1.3.1, 1.4.10, 2.1.1, 2.5.8 | Header buttons; Apply/Reset; 24 CSS px minimum, 44 preferred | Caption, headers, sort, count, active-filter summary | `11-community-graph.md` User Flows/responsive |
| High-risk confirmation | 2.1.2, 2.4.3, 3.3.4, 4.1.2 | Inline first; dialog heading focus, Tab containment, Escape before commit, return focus | Consequence, scope, version, context, step-up, irreversible effect | `11-community-graph.md` Access Control/Edge Cases |
| Motion/media | 1.2.x where applicable, 2.2.2, 2.3.3 | Media keyboard controls; pause/stop; no essential timed gesture | Captions/transcript/metadata; reduced motion; waveform never sole content | `11-community-graph.md` Accessibility |
...
|---|---|---|---|---|
| `CommunityGraphRoute` | `CommunityGraphRouteProps` | `never` | `publicPage`, `appPage`, `adminPage`, `authPage`, `degradedPage` | `11-community-graph.md` user flows/accessibility; design-system page archetypes |
| `FollowsConnectionsEndorsementsWorkbench` | `FollowsConnectionsEndorsementsWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `11a-follows-connections-endorsements.md` request/response fields; `11-community-graph.md` interactions/access rules |
| `ActivityFeedNativePostsWorkbench` | `ActivityFeedNativePostsWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `11b-activity-feed-native-posts.md` request/response fields; `11-community-graph.md` interactions/access rules |
| `CollaboratorDiscoveryCallsWorkbench` | `CollaboratorDiscoveryCallsWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `11c-collaborator-discovery-calls.md` request/response fields; `11-community-graph.md` interactions/access rules |
| `CollaborationPathsWarmIntrosWorkbench` | `CollaborationPathsWarmIntrosWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `11d-collaboration-paths-warm-intros.md` request/response fields; `11-community-graph.md` interactions/access rules |
| `PrivateRolodexCrmWorkbench` | `PrivateRolodexCrmWorkbenchProps` | `never` | `publicRead`, `entitledRead`, `ownerFull`, `guardianMandate`, `juniorRestricted`, `businessMandate`, `staffCaseScoped`, `adminStepUp`, `forbiddenHidden`, `disabledPrerequisite` | `11e-private-rolodex-crm.md` request/response fields; `11-community-graph.md` interactions/access rules |
...
|---|---|---|---|
| `COM-01` Follow/unfollow entity | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-01` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-02` Request professional connection | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-02` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-03` Endorse collaborator | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-03` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-04` Read activity feed | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-04` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-05` Mute/reduce feed source | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-05` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-06` Publish/react to native post | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-06` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-07` Search collaborators | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-07` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-08` Set open-to status | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-08` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-09` Publish collaboration call | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-09` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-10` Accept call responder | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-10` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-11` Find intro path | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-11` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-12` Suppress graph edge | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-12` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-13` Request warm intro | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-13` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-14` Broker introduction | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-14` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-15` Evaluate reachability | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-15` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-16` Create/reconcile shadow contact | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-16` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-17` Add private note/tag/list | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-17` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
| `COM-18` Schedule follow-up | `CommunityGraphRoute` orchestrates; `FollowsConnectionsEndorsementsWorkbench`, `ActivityFeedNativePostsWorkbench`, `CollaboratorDiscoveryCallsWorkbench`, `CollaborationPathsWarmIntrosWorkbench`, `PrivateRolodexCrmWorkbench` renders the relevant BE response and command state | `11-community-graph.md` Interactions row `COM-18` | Pressed/pending state in the same animation frame; inline progress after 250 ms; result or typed error text plus polite announcement within 100 ms of parsed response; 150–220 ms visual transition |
...
|---|---|---|---|---|
| `/app/community-graph` | Server validates Supabase token, expiry, acting context, and route capability. Missing/expired token redirects 303 to `/auth/sign-in?returnTo=%2Fapp%2Fcommunity-graph` after allowlist normalization. Valid but concealed target returns 404; visible forbidden target renders `CapabilityGate`. | `CommunityGraphRoute` variant `appPage` | `Social graph and collaborator network | WeJammin` | `Work with social graph and collaborator network using current authority, record state, and provenance.` |
| `/app/community-graph/:recordId` | Same token/expiry/context check; malformed ID returns 400, concealed/unreadable returns 404, expired session uses the same safe sign-in redirect. | `CommunityGraphRoute` with the matching workbench detail variant | `Record | Social graph and collaborator network | WeJammin` | `Review the current record, provenance, history, and permitted actions.` |
| Public projection when a BE route declares one | No session accepted as authority; public projection only. Unsafe or non-public record returns disclosure-safe 404, never app-shell redirect. | `CommunityGraphRoute` variant `publicPage` | `Social graph and collaborator network | WeJammin` | `View the public, provenance-labelled record.` |
| System/degraded boundary | Preserves verified shell only; Retry stays on canonical URL; unsafe cached data is removed. | `CommunityGraphRoute` variant `degradedPage` | `Service status | WeJammin` | `Review affected scope, last verified time, request ID, and recovery action.` |

### Per-component responsive contract

| Component | Mobile ≤768 px | Tablet 769–1024 px | Desktop ≥1025 px |
|---|---|---|---|
| `CommunityGraphRoute` | Four-column shell, 16 px gutter/margins, compact tabs, stack navigation, Back before detail, no horizontal page scroll at 320 CSS px | Eight-column shell, 20 px gutter, 24 px margins, collapsible sidebar, list/inspector when container permits | Twelve-column shell, 24 px gutter, max 1440 px, persistent sidebar/top bar, stable route heading/action region |
...
| `ActivityFeedNativePostsWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
| `CollaboratorDiscoveryCallsWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
| `CollaborationPathsWarmIntrosWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
| `PrivateRolodexCrmWorkbench` | List then detail stack; priority facts remain; action bar avoids virtual keyboard; controls at least 44 by 44 px | List plus inline inspector or stack by container; two-column fields only when independent; lower-priority columns move into row details | List/detail workbench; compact semantic table; virtualize over 100 rows; detail/action rail shows acting context and version |
...
| `ActivityFeedNativePostsWorkbench` | ≤35 KB hydrated entry | Detail/editor/media/export modules dynamic-import on selection; list over 100 virtualizes; no barrel import | Preserve intrinsic dimensions; thumbnails use bounded variants; originals never download for list rows | Long task off main thread or chunked; no task >50 ms during input |
| `CollaboratorDiscoveryCallsWorkbench` | ≤35 KB hydrated entry | Detail/editor/media/export modules dynamic-import on selection; list over 100 virtualizes; no barrel import | Preserve intrinsic dimensions; thumbnails use bounded variants; originals never download for list rows | Long task off main thread or chunked; no task >50 ms during input |
| `CollaborationPathsWarmIntrosWorkbench` | ≤35 KB hydrated entry | Detail/editor/media/export modules dynamic-import on selection; list over 100 virtualizes; no barrel import | Preserve intrinsic dimensions; thumbnails use bounded variants; originals never download for list rows | Long task off main thread or chunked; no task >50 ms during input |
| `PrivateRolodexCrmWorkbench` | ≤35 KB hydrated entry | Detail/editor/media/export modules dynamic-import on selection; list over 100 virtualizes; no barrel import | Preserve intrinsic dimensions; thumbnails use bounded variants; originals never download for list rows | Long task off main thread or chunked; no task >50 ms during input |
...
|---|---|---|---|---|
| `11a-follows-connections-endorsements.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
| `11b-activity-feed-native-posts.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
| `11c-collaborator-discovery-calls.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
| `11d-collaboration-paths-warm-intros.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
| `11e-private-rolodex-crm.md` | Exact named Zod request schema: type, optionality, default, min/max/enum/format, cross-field rule; safe local checks on blur and full authoritative check on submit | Linked summary plus exact field errors; preserve all valid and server-accepted input; no raw upstream copy | One idempotent commit with expected version; stable pending label; parsed authoritative response replaces draft; result heading receives focus | CSRF/origin rule by credential mode, unknown-key rejection, allowlist sanitization, framework output encoding, secret/PII redaction |
...
|---|---|---|---|---|
| `11a-follows-connections-endorsements.md` | `11A-FOLLOWS-CONNECTIONS-ENDORSEMENTS-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `FollowsConnectionsEndorsementsWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |
| `11b-activity-feed-native-posts.md` | `11B-ACTIVITY-FEED-NATIVE-POSTS-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `ActivityFeedNativePostsWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |
| `11c-collaborator-discovery-calls.md` | `11C-COLLABORATOR-DISCOVERY-CALLS-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `CollaboratorDiscoveryCallsWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |
| `11d-collaboration-paths-warm-intros.md` | `11D-COLLABORATION-PATHS-WARM-INTROS-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `CollaborationPathsWarmIntrosWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |
| `11e-private-rolodex-crm.md` | `11E-PRIVATE-ROLODEX-CRM-REGISTRY` | `REGISTERED See route registry` | `2xx` parsed into `PrivateRolodexCrmWorkbench`; update only after validation | BE00 typed envelope to inline, capability, conflict, rate-wait, or degraded state |

### Response field ownership

| BE source | Contract schemas | Parsed field set | UI ownership |
|---|---|---|---|
| `11a-follows-connections-endorsements.md` | Named source schemas | `FollowAlertScope`, `ConnectionState`, `SetFollow`, `RequestConnection`, `CreateEndorsement`, `StandardError`, `follow_edge`, `connection_request`, `professional_connection`, `endorsement`, `COM04_READ_FEED`, `COM05_SET_FEED_PREFERENCE`, `COM06_NATIVE_POST_ACTION`, `COM07_SEARCH_COLLABORATORS`, `COM10_ACCEPT_CALL_RESPONSE`, `COM11_FIND_INTRO_PATH`, `COM15_RESOLVE_REACHABILITY`, `COM16_SHADOW_CONTACT_ACTION`, `COM18_FOLLOW_UP_REMINDER_ACTION`, `follow`, `request`, `create`, `SetFollowRequest`, `SetFollowResult`, `RequestConnectionAction`, `RequestConnectionResult`, `CreateEndorsementAction`, `CreateEndorsementResult`, `community_private`, `evidence_ref`, `reachability_policy_version`, `migration_role`, `search_path`, `follow_action_total`, `connection_action_total`, `endorsement_action_total` | `FollowsConnectionsEndorsementsWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
| `11b-activity-feed-native-posts.md` | Named source schemas | `ProjectFeed`, `activity_event_projection`, `feed_preference`, `native_post`, `post_reaction`, `COM04_READ_FEED`, `COM05_SET_FEED_PREFERENCE`, `COM06_NATIVE_POST_ACTION`, `ProjectFeedRequest`, `ProjectFeedResult`, `FeedPreferencePath`, `SetFeedPreferenceRequest`, `SetFeedPreferenceResult`, `NativePostActionRequest`, `NativePostActionResult`, `timestamptz`, `owner_id`, `moderation_case_id`, `anon`, `authenticated`, `search_path`, `eventId` | `ActivityFeedNativePostsWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
| `11c-collaborator-discovery-calls.md` | Named source schemas | `AppetiteState`, `SearchCollaborators`, `ComputeFit`, `PublishCall`, `collaborator_search_document`, `open_to_signal`, `collaboration_call`, `call_response`, `COM07_SEARCH_COLLABORATORS`, `COM08_SET_OPEN_TO_SIGNAL`, `COM09_PUBLISH_COLLABORATION_CALL`, `COM10_ACCEPT_CALL_RESPONSE`, `SearchCollaboratorsResult`, `OpenToSignalPath`, `SetOpenToSignalRequest`, `SetOpenToSignalResult`, `PublishCallResult`, `CallPath`, `AcceptCallResponseRequest`, `AcceptCallResponseResult`, `proposedBasisPoints`, `owner_id`, `accepted_response_id`, `call_id`, `degraded_self_tag`, `setup_failed_retryable`, `eventId`, `field`, `reasonCode`, `currentVersion`, `retryAfterSeconds` | `CollaboratorDiscoveryCallsWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
| `11d-collaboration-paths-warm-intros.md` | Named source schemas | `GraphPathResult`, `Reachability`, `StandardError`, `FindIntroPath`, `SuppressCollaborationEdge`, `RequestIntro`, `OpenIntroChannel`, `ResolveReachability`, `collaboration_edge_evidence`, `edge_suppression`, `intro_request`, `intro_channel`, `reachability_policy_version`, `COM11_FIND_INTRO_PATH`, `COM12_SUPPRESS_EDGE`, `COM13_REQUEST_INTRO`, `COM14_BROKER_INTRO_DECISION`, `COM15_RESOLVE_REACHABILITY`, `direct`, `intro_required`, `unavailable`, `FindIntroPathResult`, `SuppressEdgeResult`, `RequestIntroResult`, `OpenIntroChannelResult`, `ResolveReachabilityResult`, `channelId`, `awaiting_target`, `owner_id`, `created_by`, `anon`, `authenticated`, `search_path`, `no_path_within_intro_range`, `degraded` | `CollaborationPathsWarmIntrosWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
| `11e-private-rolodex-crm.md` | Named source schemas | `CreateShadowContact`, `WritePrivateNote`, `StandardError`, `shadow_contact`, `private_contact_note`, `private_contact_tag`, `follow_up_reminder`, `community_audit_event`, `COM16_SHADOW_CONTACT_ACTION`, `COM17_PRIVATE_CONTEXT_ACTION`, `COM18_FOLLOW_UP_REMINDER_ACTION`, `ShadowContactActionRequest`, `ShadowContactActionResult`, `PrivateContextActionRequest`, `PrivateContextActionResult`, `FollowUpReminderActionRequest`, `FollowUpReminderActionResult`, `NoteAction`, `owner_id`, `anon`, `authenticated`, `search_path`, `canonical_target_party_id`, `delivery_failed_retryable`, `deliveryKey` | `PrivateRolodexCrmWorkbench`: identity/version/state in `<RecordHeader>`; provenance in `<ProvenanceFact>`; command/status in `<ActionBar>`/`<StateLabel>`; remaining authorized facts in detail rows; security-only fields never serialize |
...
```ts
type FollowsConnectionsEndorsementsContractField =
  | 'COM04_READ_FEED'
  | 'COM05_SET_FEED_PREFERENCE'
  | 'COM06_NATIVE_POST_ACTION'
  | 'COM07_SEARCH_COLLABORATORS'
  | 'COM10_ACCEPT_CALL_RESPONSE'
  | 'COM11_FIND_INTRO_PATH'
  | 'COM15_RESOLVE_REACHABILITY'
  | 'COM16_SHADOW_CONTACT_ACTION'
  | 'COM18_FOLLOW_UP_REMINDER_ACTION'
  | 'ConnectionState'
  | 'CreateEndorsement'
  | 'CreateEndorsementAction'
  | 'CreateEndorsementResult'
  | 'FollowAlertScope'
  | 'RequestConnection'
  ...
  | 'StandardError'
  | 'community_private'
  | 'connection_action_total'
  | 'connection_request'
  | 'create'
  | 'endorsement'
  | 'endorsement_action_total'
  | 'evidence_ref'
  | 'follow'
  | 'follow_action_total'
  | 'follow_edge'
  ...
  | 'request'
  | 'search_path';
interface FollowsConnectionsEndorsementsWorkbenchContractFields {
  source: '11a-follows-connections-endorsements.md';
  fields: Readonly<Record<FollowsConnectionsEndorsementsContractField, unknown>>;
}
```

```ts
type ActivityFeedNativePostsContractField =
  | 'ApiError'
  | 'COM04_READ_FEED'
  | 'COM05_SET_FEED_PREFERENCE'
  | 'COM06_NATIVE_POST_ACTION'
  | 'FeedPreferencePath'
  | 'NativePostActionRequest'
  | 'NativePostActionResult'
  | 'ProjectFeed'
  | 'ProjectFeedRequest'
  | 'ProjectFeedResult'
  | 'SetFeedPreferenceRequest'
  | 'SetFeedPreferenceResult'
  | 'activity_event_projection'
  | 'anon'
  | 'authenticated'
  | 'eventId'
  | 'feed_preference'
  ...
  | 'search_path'
  | 'timestamptz';
interface ActivityFeedNativePostsWorkbenchContractFields {
  source: '11b-activity-feed-native-posts.md';
  fields: Readonly<Record<ActivityFeedNativePostsContractField, unknown>>;
}
```

```ts
type CollaboratorDiscoveryCallsContractField =
  | 'AcceptCallResponseRequest'
  | 'AcceptCallResponseResult'
  | 'AppetiteState'
  | 'COM07_SEARCH_COLLABORATORS'
  | 'COM08_SET_OPEN_TO_SIGNAL'
  | 'COM09_PUBLISH_COLLABORATION_CALL'
  | 'COM10_ACCEPT_CALL_RESPONSE'
  | 'CallPath'
  | 'ComputeFit'
  ...
  | 'PublishCallResult'
  | 'SearchCollaborators'
  | 'SearchCollaboratorsResult'
  | 'SetOpenToSignalRequest'
  | 'SetOpenToSignalResult'
  | 'accepted_response_id'
  | 'call_id'
  | 'call_response'
  | 'collaboration_call'
  | 'collaborator_search_document'
  | 'currentVersion'
  | 'degraded_self_tag'
  | 'eventId'
  | 'field'
  ...
  | 'reasonCode'
  | 'retryAfterSeconds'
  | 'setup_failed_retryable';
interface CollaboratorDiscoveryCallsWorkbenchContractFields {
  source: '11c-collaborator-discovery-calls.md';
  fields: Readonly<Record<CollaboratorDiscoveryCallsContractField, unknown>>;
}
```

```ts
type CollaborationPathsWarmIntrosContractField =
  | 'COM11_FIND_INTRO_PATH'
  | 'COM12_SUPPRESS_EDGE'
  | 'COM13_REQUEST_INTRO'
  | 'COM14_BROKER_INTRO_DECISION'
  | 'COM15_RESOLVE_REACHABILITY'
  | 'FindIntroPath'
  | 'FindIntroPathResult'
  | 'GraphPathResult'
  | 'OpenIntroChannel'
  | 'OpenIntroChannelResult'
  | 'Reachability'
  | 'RequestIntro'
  | 'RequestIntroResult'
  | 'ResolveReachability'
  | 'ResolveReachabilityResult'
  | 'StandardError'
  | 'SuppressCollaborationEdge'
  | 'SuppressEdgeResult'
  | 'anon'
  ...
  | 'intro_request'
  | 'intro_required'
  | 'no_path_within_intro_range'
  | 'owner_id'
  | 'reachability_policy_version'
  | 'search_path'
  | 'unavailable';
interface CollaborationPathsWarmIntrosWorkbenchContractFields {
  source: '11d-collaboration-paths-warm-intros.md';
  fields: Readonly<Record<CollaborationPathsWarmIntrosContractField, unknown>>;
}
```

```ts
type PrivateRolodexCrmContractField =
  | 'COM16_SHADOW_CONTACT_ACTION'
  | 'COM17_PRIVATE_CONTEXT_ACTION'
  | 'COM18_FOLLOW_UP_REMINDER_ACTION'
  | 'CreateShadowContact'
  | 'FollowUpReminderActionRequest'
  | 'FollowUpReminderActionResult'
  | 'NoteAction'
  | 'PrivateContextActionRequest'
  | 'PrivateContextActionResult'
  | 'ShadowContactActionRequest'
  | 'ShadowContactActionResult'
  | 'StandardError'
  | 'WritePrivateNote'
  | 'anon'
  | 'authenticated'
  | 'canonical_target_party_id'
  | 'community_audit_event'
  | 'deliveryKey'
  | 'delivery_failed_retryable'
  | 'follow_up_reminder'
  | 'owner_id'
  | 'private_contact_note'
  | 'private_contact_tag'
  | 'search_path'
  | 'shadow_contact';
interface PrivateRolodexCrmWorkbenchContractFields {
  source: '11e-private-rolodex-crm.md';
  fields: Readonly<Record<PrivateRolodexCrmContractField, unknown>>;
}
```

| BE source | Owning component/prop | Every discovered application error code | UI state owner |
|---|---|---|---|
| `11a-follows-connections-endorsements.md` | `FollowsConnectionsEndorsementsWorkbenchContractFields.fields` and `FollowsConnectionsEndorsementsWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `BLOCKED_ROUTE`, `DEPENDENCY_UNAVAILABLE`, `FORBIDDEN`, `IDEMPOTENCY_MISMATCH`, `NOT_FOUND`, `RATE_LIMITED`, `UNAUTHENTICATED`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
| `11b-activity-feed-native-posts.md` | `ActivityFeedNativePostsWorkbenchContractFields.fields` and `ActivityFeedNativePostsWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `BLOCKED_ROUTE`, `DEPENDENCY_UNAVAILABLE`, `FORBIDDEN`, `IDEMPOTENCY_MISMATCH`, `NOT_FOUND`, `RATE_LIMITED`, `UNAUTHENTICATED`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
| `11c-collaborator-discovery-calls.md` | `CollaboratorDiscoveryCallsWorkbenchContractFields.fields` and `CollaboratorDiscoveryCallsWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `BLOCKED_ROUTE`, `DEPENDENCY_UNAVAILABLE`, `FORBIDDEN`, `IDEMPOTENCY_MISMATCH`, `NOT_FOUND`, `RATE_LIMITED`, `UNAUTHENTICATED`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
| `11d-collaboration-paths-warm-intros.md` | `CollaborationPathsWarmIntrosWorkbenchContractFields.fields` and `CollaborationPathsWarmIntrosWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `BLOCKED_ROUTE`, `DEPENDENCY_UNAVAILABLE`, `FORBIDDEN`, `IDEMPOTENCY_MISMATCH`, `NOT_FOUND`, `RATE_LIMITED`, `UNAUTHENTICATED`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
| `11e-private-rolodex-crm.md` | `PrivateRolodexCrmWorkbenchContractFields.fields` and `PrivateRolodexCrmWorkbenchProps.contractFields` | `ACTING_CONTEXT_STALE`, `BLOCKED_ROUTE`, `DEPENDENCY_UNAVAILABLE`, `FORBIDDEN`, `IDEMPOTENCY_MISMATCH`, `NOT_FOUND`, `RATE_LIMITED`, `UNAUTHENTICATED`, `VALIDATION_FAILED`, `VERSION_CONFLICT` | validation/input → linked summary; auth/permission → auth or capability gate; not-found → disclosure-safe route/row; conflict/stale/mismatch/duplicate → sync conflict; rate → retry wait; dependency/timeout/unavailable → degraded; blocked/failed/cancelled/revoked → exact terminal state and legitimate recovery |
