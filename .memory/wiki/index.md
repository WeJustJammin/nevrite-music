...
- [[specs/audits/verify-infrastructure-2026-09-06-0300|Infrastructure Verification Report: Slice 09 observability-token preflight]] — audit — spec-vault
...
- [[specs/be/01c-relationships-authority-governance|Relationships, Authority & Governance — Backend Specification]] — be-spec — spec-vault
- [[specs/be/01d-identifiers-legacy|Identifiers & Legacy — Backend Specification]] — be-spec — spec-vault
- [[specs/be/02a-shadow-claim-ownership|Shadow Claims & Ownership — Backend Specification]] — be-spec — spec-vault
- [[specs/be/02b-profile-portfolio-epk|Profile, Portfolio & EPK — Backend Specification]] — be-spec — spec-vault
- [[specs/be/02c-credentials-trader|Credentials & Trader Classification — Backend Specification]] — be-spec — spec-vault
- [[specs/be/03a-content-schema-registry|Content Schema Registry — Backend Specification]] — be-spec — spec-vault
- [[specs/be/03b-editorial-workflow-publication|Editorial Workflow and Publication — Backend Specification]] — be-spec — spec-vault
- [[specs/be/03c-composition-taxonomy-localization|Composition, Taxonomy, and Localization — Backend Specification]] — be-spec — spec-vault
- [[specs/be/04a-navigation-routes-discovery|CMS Navigation, Routes & Discovery — Backend Specification]] — be-spec — spec-vault
- [[specs/be/04b-governed-media-renditions|Governed Media and Renditions — Backend Specification]] — be-spec — spec-vault
- [[specs/be/04c-public-delivery-cache|Public Delivery & Cache — Backend Specification]] — be-spec — spec-vault
- [[specs/be/05a-settings-flags-runtime|BE 05a — Settings, flags and runtime governance]] — be-spec — spec-vault
- [[specs/be/05b-admin-workspace-operations|BE 05b — Admin workspace and operations]] — be-spec — spec-vault
- [[specs/be/05c-portability-quality-lifecycle|BE 05c — Portability, quality and lifecycle]] — be-spec — spec-vault
- [[specs/be/06a-case-intake-evidence|BE 06a — Case intake and evidence]] — be-spec — spec-vault
- [[specs/be/06b-policy-enforcement-appeals|BE 06b — Policy, enforcement and appeals]] — be-spec — spec-vault
- [[specs/be/06c-disputes-dmca-legal-risk|BE 06c — Disputes, DMCA, legal process and specialized safety risk]] — be-spec — spec-vault
- [[specs/be/07a-credit-assertions-visibility|BE 07a — Credit assertions, visibility and graph projections]] — be-spec — spec-vault
- [[specs/be/07b-session-capture-offline|BE 07b — Session capture, contribution logging and offline convergence]] — be-spec — spec-vault
- [[specs/be/07c-claims-attestations-confidence-taxonomy|BE 07c — Claims, attestations, provenance confidence and taxonomy]] — be-spec — spec-vault
- [[specs/be/08a-portability-ddex-emission|BE 08a — Portability, DDEX/RIN emission and artifact lifecycle]] — be-spec — spec-vault
- [[specs/be/08b-union-session-reporting|BE 08b — Union and performer session reporting]] — be-spec — spec-vault
- [[specs/be/08c-gear-credit-linkage|BE 08c — Gear-to-credit linkage and item discography]] — be-spec — spec-vault
- [[specs/be/08d-ai-contribution-disclosure|BE 08d — AI contribution disclosure]] — be-spec — spec-vault
- [[specs/be/09a-project-containers-creative-docs|BE-09a — Project containers and creative documents]] — be-spec — spec-vault
- [[specs/be/09b-roster-invitations-vault-access|BE-09b — Roster, invitations and vault access]] — be-spec — spec-vault
- [[specs/be/09c-audio-version-review-approval|BE-09c — Audio versions, lineage, review and approval]] — be-spec — spec-vault
- [[specs/be/09d-sessions-delivery-readiness|BE-09d — Sessions, recall, delivery and readiness]] — be-spec — spec-vault
- [[specs/be/09e-daw-bridge-evidence-gate|BE-09e — DAW bridge evidence gate]] — be-spec — spec-vault
- [[specs/be/10a-rights-objects-ledgers|Rights Objects and Consent Ledgers — Backend Specification]] — be-spec — spec-vault
- [[specs/be/10b-splits-points-buyouts-amendments|Splits, Points, Buyouts and Ledger Amendments — Backend Specification]] — be-spec — spec-vault
- [[specs/be/10c-title-control-conflicts-freezes|Title, Control, Conflicts and Freezes — Backend Specification]] — be-spec — spec-vault
- [[specs/be/10d-ai-training-nil-consent|AI-Training, NIL and AI-Content Consent — Backend Specification]] — be-spec — spec-vault
- [[specs/be/10e-identifiers-registration-evidence|Identifiers, Registration and Rights Evidence — Backend Specification]] — be-spec — spec-vault
- [[specs/be/11a-follows-connections-endorsements|Follows, Connections & Endorsements — Backend Specification]] — be-spec — spec-vault
- [[specs/be/11b-activity-feed-native-posts|Activity Feed & Native Posts — Backend Specification]] — be-spec — spec-vault
- [[specs/be/11c-collaborator-discovery-calls|Collaborator Discovery & Calls — Backend Specification]] — be-spec — spec-vault
- [[specs/be/11d-collaboration-paths-warm-intros|Collaboration Paths & Warm Introductions — Backend Specification]] — be-spec — spec-vault
- [[specs/be/11e-private-rolodex-crm|Private Rolodex & CRM — Backend Specification]] — be-spec — spec-vault
- [[specs/be/12a-scenes-stewardship-seeding|BE Spec 12a — Scenes, Stewardship, Density, and Seeding]] — be-spec — spec-vault
- [[specs/be/12b-craft-forums-qa|BE Spec 12b — Craft Forums and Q&A]] — be-spec — spec-vault
- [[specs/be/12c-contests-submissions-judging|BE Spec 12c — Contests, Submissions, Judging, and Awards]] — be-spec — spec-vault
- [[specs/be/12d-informal-listening-conference-events|BE Spec 12d — Informal Events, Listening Rooms, Conference Mode, and Event Relationships]] — be-spec — spec-vault
- [[specs/be/13a-opportunity-publication-discovery-alerts|Opportunity Publication, Discovery & Alerts — Backend Specification]] — be-spec — spec-vault
- [[specs/be/13b-submissions-auditions-pitches|Opportunity Submissions, Auditions & Pitches — Backend Specification]] — be-spec — spec-vault
- [[specs/be/13c-triage-offers-dispositions|Opportunity Triage, Offers & Dispositions — Backend Specification]] — be-spec — spec-vault
- [[specs/be/13d-handoff-history-specialized-calls|Opportunity Handoff, History & Specialized Calls — Backend Specification]] — be-spec — spec-vault
- [[specs/be/14a-service-listings-quotes-engagements|Service Listings, Quotes & Engagements — Backend Specification]] — be-spec — spec-vault
- [[specs/be/14b-requirements-sla-milestones-revisions|Requirements, SLA, Milestones & Revisions — Backend Specification]] — be-spec — spec-vault
- [[specs/be/14c-delivery-acceptance-exit-rights|Delivery, Acceptance, Exit & Recall — Backend Specification]] — be-spec — spec-vault
- [[specs/be/14d-substitution-multiparty-supply|Substitution & Multi-Party Supply — Backend Specification]] — be-spec — spec-vault
- [[specs/be/14e-repair-inspection-custody|Repair, Inspection & Custody — Backend Specification]] — be-spec — spec-vault
- [[specs/be/15a-teacher-facets-discovery-trials|Teacher Facets, Discovery & Trial Conversion — Backend Specification]] — be-spec — spec-vault
- [[specs/be/15b-lesson-booking-credits-delivery|Lesson Booking, Credits & Delivery — Backend Specification]] — be-spec — spec-vault
- [[specs/be/15c-curriculum-feedback-practice|Curriculum, Feedback, Practice & Progress — Backend Specification]] — be-spec — spec-vault
- [[specs/be/15d-group-mentorship-learning-paths|Group Classes, Mentorship & Learning Paths — Backend Specification]] — be-spec — spec-vault
- [[specs/be/16a-course-authoring-publication-catalog|Course Authoring, Publication & Catalog — Backend Specification]] — be-spec — spec-vault
- [[specs/be/16b-course-commerce-consumption-refunds|Course Commerce, Consumption & Refunds — Backend Specification]] — be-spec — spec-vault
- [[specs/be/16c-exam-evidence-credential-exclusion|Exam Evidence, Goals & Credential Boundary — Backend Specification]] — be-spec — spec-vault
- [[specs/be/16d-institution-gate-clinical-exclusion|Institution Gate, Academy Operations & Clinical Exclusion — Backend Specification]] — be-spec — spec-vault
- [[specs/be/17a-runtime-admission-latency-discovery|Runtime Admission, Preflight, Path Measurement & Discovery — Backend Specification]] — be-spec — spec-vault
- [[specs/be/17b-live-room-monitoring-controls|Live Room, Cue, Talkback & Monitoring Controls — Backend Specification]] — be-spec — spec-vault
- [[specs/be/17c-continuity-capture-alignment-attendance|Continuity, Capture, Alignment & Attendance — Backend Specification]] — be-spec — spec-vault
- [[specs/be/17d-overdub-requests-delivery|Overdub Requests & Delivery — Backend Specification]] — be-spec — spec-vault
- [[specs/be/18a-society-affiliation-registration|Society Affiliation & Registration — Backend Specification]] — be-spec — spec-vault
- [[specs/be/18b-statement-ingestion-matching-normalization|Statement Ingestion, Matching & Normalization — Backend Specification]] — be-spec — spec-vault
- [[specs/be/18c-royalty-calculation-restatement-statements|Royalty Calculation, Restatement & Statements — Backend Specification]] — be-spec — spec-vault
- [[specs/be/18d-royalty-payout-b3-gate|Royalty Payout & B3 Gate — Backend Specification]] — be-spec — spec-vault
- [[specs/be/18e-royalty-recovery-statement-disputes|Royalty Recovery & Statement Disputes — Backend Specification]] — be-spec — spec-vault
- [[specs/be/19a-live-returns-cue-sheet-expectations|Live Returns & Cue-Sheet Expectations — Backend Specification]] — be-spec — spec-vault
- [[specs/be/19b-distribution-calendar-money-in-flight|Distribution Calendars & Money-in-Flight — Backend Specification]] — be-spec — spec-vault
- [[specs/be/19c-royalty-forecast-calibration|Royalty Forecast & Calibration — Backend Specification]] — be-spec — spec-vault
- [[specs/be/20a-sync-catalogue-briefs-holds|Sync Catalogue, Briefs and Holds — Backend Specification]] — be-spec — spec-vault
- [[specs/be/20b-clearance-evidence-consent|Clearance Evidence and Consent — Backend Specification]] — be-spec — spec-vault
- [[specs/be/20c-owner-policy-quotes-mfn|Owner Policy, Quotes and MFN — Backend Specification]] — be-spec — spec-vault
- [[specs/be/20d-licence-issuance-verification-lifecycle|Licence Issuance, Verification and Lifecycle — Backend Specification]] — be-spec — spec-vault
- [[specs/be/21a-sample-interpolation-remix-clearance|Sample, Interpolation & Remix Clearance — Backend Specification]] — be-spec — spec-vault
- [[specs/be/21b-creator-microlicensing-content-id|Creator Micro-Licensing & Content ID — Backend Specification]] — be-spec — spec-vault
- [[specs/be/21c-ai-training-corpus-compensation|AI Training Consent, Corpus & Compensation — Backend Specification]] — be-spec — spec-vault
- [[specs/be/21d-cover-print-grand-right-routing|Cover, Print & Grand-Right Routing — Backend Specification]] — be-spec — spec-vault
- [[specs/be/22a-release-build-readiness-footprint|BE-22a — Release Build, Readiness and Distribution Footprint]] — be-spec — spec-vault
- [[specs/be/22b-partner-message-delivery-status|BE-22b — Partner Message, Delivery and Status]] — be-spec — spec-vault
- [[specs/be/22c-release-promotion-updates-takedowns|BE-22c — Release Promotion, Updates and Takedowns]] — be-spec — spec-vault
- [[specs/be/22d-ugc-claims-catalogue-migration|BE-22d — UGC Claims, Catalogue Migration and Release Enrichment]] — be-spec — spec-vault
- [[specs/be/23a-gear-identity-claims-transfers|BE-23a — Gear Identity, Claims and Transfers]] — be-spec — spec-vault
- [[specs/be/23b-theft-screening-recovery|BE-23b — Theft Screening and Recovery]] — be-spec — spec-vault
- [[specs/be/23c-service-component-history|BE-23c — Gear Service and Component History]] — be-spec — spec-vault
- [[specs/be/23d-valuation-insurance-discography|BE-23d — Gear Valuation, Insurance Packs and Discography Links]] — be-spec — spec-vault
- [[specs/be/24a-gear-collections-publication|BE-24a — Gear Collections and Safe Publication]] — be-spec — spec-vault
- [[specs/be/24b-rigs-compatibility-exports|BE-24b — Rigs, Compatibility and Source Exports]] — be-spec — spec-vault
- [[specs/be/24c-organization-register-backline|BE-24c — Organisation Registers, Condition and Public Backline]] — be-spec — spec-vault
- [[specs/be/24d-custody-cases-manifests|BE-24d — Custody, Cases, Manifests and Readiness]] — be-spec — spec-vault
- [[specs/be/25a-gear-catalog-authority-matching|BE-25a — Gear Catalog Authority and Listing Matching]] — be-spec — spec-vault
- [[specs/be/25b-gear-listing-disclosure-lifecycle|BE-25b — Gear Listing Disclosure and Lifecycle]] — be-spec — spec-vault
- [[specs/be/25c-gear-inventory-bulk-channels|BE-25c — Gear Inventory, Bulk Listing, and Channel Availability]] — be-spec — spec-vault
- [[specs/be/25d-gear-market-guides-storefront-policies|BE-25d — Gear Market Guides, Provenance, and Storefront Policies]] — be-spec — spec-vault
- [[specs/be/26a-gear-offers-cart-checkout|BE-26a — Gear Offers, Mixed Cart, and Checkout Groups]] — be-spec — spec-vault
- [[specs/be/26b-gear-logistics-order-lifecycle|BE-26b — Gear Freight, Shipment, and Order Lifecycle]] — be-spec — spec-vault
- [[specs/be/26c-gear-remedies-settlement-transfers|BE-26c — Gear Remedies, Settlement, and Ownership Transfers]] — be-spec — spec-vault
- [[specs/be/26d-gear-pickup-service-warranty|BE-26d — Gear Pickup, Pre-Dispatch Service, and Warranty Routing]] — be-spec — spec-vault
- [[specs/be/26e-gear-future-commerce-gates|BE-26e — Gear International and Future Commerce Gates]] — be-spec — spec-vault
- [[specs/be/27a-digital-product-catalog-compatibility|BE-27a — Digital Product Catalog and Compatibility]] — be-spec — spec-vault
- [[specs/be/27b-digital-submission-qa-publication|BE-27b — Digital Submission, QA, Review, and Publication]] — be-spec — spec-vault
- [[specs/be/27c-digital-entitlements-library-delivery|BE-27c — Digital Entitlements, Holder Library, and Delivery]] — be-spec — spec-vault
- [[specs/be/27d-digital-updates-assets-trials|BE-27d — Digital Updates, Assets, Release Channels, and Trials]] — be-spec — spec-vault
- [[specs/be/27e-digital-enforcement-retirement-portability|BE-27e — Digital Enforcement, Retirement, and Portability]] — be-spec — spec-vault
- [[specs/be/28a-digital-purchases-beat-licensing|Digital Purchases and Beat Licensing — Backend Specification]] — be-spec — spec-vault
- [[specs/be/28b-digital-refunds-revocation-clearance|Digital Refunds, Revocation and Clearance — Backend Specification]] — be-spec — spec-vault
- [[specs/be/28c-digital-transfers-promotions-upgrades|Digital Transfers, Promotions and Upgrades — Backend Specification]] — be-spec — spec-vault
- [[specs/be/28d-digital-contributor-revenue|Digital Contributor Revenue — Backend Specification]] — be-spec — spec-vault
- [[specs/be/29a-place-room-authority-status|Place & Room Authority and Status — Backend Specification]] — be-spec — spec-vault
- [[specs/be/29b-room-specs-accessibility-conformance|Room Specifications, Accessibility & Conformance — Backend Specification]] — be-spec — spec-vault
- [[specs/be/29c-room-calendars-holds-enquiries|Room Calendars, Holds & Enquiries — Backend Specification]] — be-spec — spec-vault
- [[specs/be/29d-room-reservations-series-handoff|Room Reservations, Series & Performance Handoff — Backend Specification]] — be-spec — spec-vault
- [[specs/be/30a-booking-avails-commercial-positions|BE Spec 30a — Booking Avails and Commercial Positions]] — be-spec — spec-vault
- [[specs/be/30b-booking-offers-approval-acceptance|BE Spec 30b — Booking Offers, Approvals, and Acceptance]] — be-spec — spec-vault
- [[specs/be/30c-booking-documents-payments-announcement|BE Spec 30c — Deal Documents, Payments, and Announcement Governance]] — be-spec — spec-vault
- [[specs/be/30d-booking-cancellation-postponement-exclusivity|BE Spec 30d — Booking Cancellation, Force Majeure, Postponement, and Exclusivity]] — be-spec — spec-vault
- [[specs/be/30e-booking-rfq-bill-construction|BE Spec 30e — Booking RFQ and Bill Construction]] — be-spec — spec-vault
- [[specs/be/31a-agency-terms-pipeline-commission|Agency Terms, Pipeline and Commission — Backend Specification]] — be-spec — spec-vault
- [[specs/be/31b-settlement-inputs-reconciliation-disputes|Settlement Inputs, Reconciliation and Disputes — Backend Specification]] — be-spec — spec-vault
- [[specs/be/31c-settlement-finality-restatement-export|Settlement Finality, Restatement and Export — Backend Specification]] — be-spec — spec-vault
- [[specs/be/31d-live-splits-disbursement-tax|Live Splits, Disbursement and Tax Evidence — Backend Specification]] — be-spec — spec-vault
- [[specs/be/31e-live-draw-guidance-reliability-demand|Live Draw, Guidance, Reliability and Demand — Backend Specification]] — be-spec — spec-vault
- [[specs/be/32a-production-events-bill-rehearsal|Production Events, Bill and Rehearsal — Backend Specification]] — be-spec — spec-vault
- [[specs/be/32b-rider-sensitive-disclosure-redlines|Rider, Sensitive Disclosure and Redlines — Backend Specification]] — be-spec — spec-vault
- [[specs/be/32c-stage-plan-capability-allocation|Stage Plan, Capability Diff and Allocation — Backend Specification]] — be-spec — spec-vault
- [[specs/be/32d-advance-checklist-freeze|Advance Checklist, Freeze and Change Control — Backend Specification]] — be-spec — spec-vault
- [[specs/be/33a-show-setlists-files-performance|Show Setlists, Files and Performed Capture — Backend Specification]] — be-spec — spec-vault
- [[specs/be/33b-run-of-show-crew-credentials|Run of Show, Crew and Credentials — Backend Specification]] — be-spec — spec-vault
- [[specs/be/33c-gear-manifest-loadout-daysheet|Gear Manifest, Load-Out and Day Sheet — Backend Specification]] — be-spec — spec-vault
- [[specs/be/33d-safety-weather-postshow-corrections|BE Spec 33d — Safety, Weather, Post-Show Reporting, and Corrections]] — be-spec — spec-vault
- [[specs/be/34a-tour-container-routing-book|BE Spec 34a — Tour Container, Routing, and Tour Book]] — be-spec — spec-vault
- [[specs/be/34b-tour-travel-rooming-ground-perdiem|BE Spec 34b — Tour Travel, Rooming, Ground Transport, and Per Diem]] — be-spec — spec-vault
- [[specs/be/34c-tour-budgets-actuals-expenses|BE Spec 34c — Tour Budgets, Actuals, and Expenses]] — be-spec — spec-vault
- [[specs/be/34d-tour-border-merch-carbon|BE Spec 34d — Tour Border Readiness, Carnets, Merch, and Carbon]] — be-spec — spec-vault
- [[specs/be/35a-ticket-inventory-onsale-presale|BE Spec 35a — Ticket Inventory, On-Sale, Presale, and Access Codes]] — be-spec — spec-vault
- [[specs/be/35b-ticket-carts-orders-waitlists|BE Spec 35b — Ticket Queues, Carts, Orders, and Waitlists]] — be-spec — spec-vault
- [[specs/be/35c-ticket-guest-allocations-door|BE Spec 35c — Guest Allocations and Door Changes]] — be-spec — spec-vault
- [[specs/be/35d-ticket-vip-rsvp-conversion|BE Spec 35d — VIP Packages, RSVP Admission, and Free-to-Paid Conversion]] — be-spec — spec-vault
- [[specs/be/35e-ticket-delivery-transfer-claim|BE Spec 35e — Ticket Delivery, Pass Projection, and Transfer Claim]] — be-spec — spec-vault
- [[specs/be/36a-door-replicas-scans-age|Door Replicas, Scans & Age Verification — Backend Specification]] — be-spec — spec-vault
- [[specs/be/36b-boxoffice-counts-drops-walkup-close|Box-office Counts, Drops, Walk-up & Close — Backend Specification]] — be-spec — spec-vault
- [[specs/be/36c-ticket-refunds-event-changes|Ticket Refunds & Event Changes — Backend Specification]] — be-spec — spec-vault
- [[specs/be/36d-external-counts-attestation-reconciliation|External Counts, Attestation & Reconciliation — Backend Specification]] — be-spec — spec-vault
- [[specs/be/36e-ticket-limits-transfer-exchange-consent|Ticket Limits, Transfer, Exchange & Consent — Backend Specification]] — be-spec — spec-vault
...
- [[specs/be/40-market-intelligence-signals|Market Intelligence, Fraud & Scouting Signals — Backend Specification]] — be-spec — spec-vault
- [[specs/be/41a-income-tax-receivables|Income, Tax Readiness & Receivables — Backend Specification]] — be-spec — spec-vault
- [[specs/be/41b-deals-recoupment-pl|Deals, Recoupment & P&L — Backend Specification]] — be-spec — spec-vault
- [[specs/be/42-career-planning-risk|Career Planning, Insurance & Sustainability Boundary — Backend Specification]] — be-spec — spec-vault
